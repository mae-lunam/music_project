...
public class SpotifyAPI {
	...
	private static final String TOKEN_HOST = "https://api.spotify.com/oauth2/token";
	private static final String CLIENT_ID = "43vfsgfeh46";
	private static final String CLIENT_SECRET = "24534bdffbET45";
	...
	/**
	 * Create and send a request to Spotify Token Host and return the access token
	 */
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		String query = String.format("term=%s&latitude=%s&longitude=%s&limit=%s", term, latitude, longitude,
				SEARCH_LIMIT);
	...
	private void queryAPI(double lat, double lon) {
		...
		try {
			for (Item item : list) {
				// This is a thin version of the original JSONObject fetched
				// from Spotify.
	...
	/**
	 * Main entry for sample Spotify API requests.
	 */
	public static void main(String[] args) {
		SpotifyAPI SpotifyApi = new SpotifyAPI();
		SpotifyApi.queryAPI(37.38, -122.08);
	}
